...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['cat_name'] == '') {
    ...
    } else if ($_POST['cat_name'] == '--Select Category--'){
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(category_id,title,slogan,price,img) VALUE('" . $_POST['cat_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $_POST['price'] . "','" . $fnew . "')"; // store the submited data ino the database :images
                mysqli_query($db, $sql);
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step=".01" name="price" class="form-control" placeholder="$">
                                            </div>
                                        </div>
