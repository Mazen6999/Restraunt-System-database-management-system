                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="images/mma.png"
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT tables.*, users_orders.* FROM tables INNER JOIN users_orders ON tables.table_id=users_orders.table_id ";
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    if ($status == "cancelledandleft") {
                                                        ...
                                                        <td> <button type="button" class="btn btn-danger"> <i
                                                                    class="fa fa-close"></i> Cancelled and left</button></td>
                                                    <?php
                                                    }
                                                    ?>
                                                    <?php
                                                    echo '	<td>' . $rows['paymethod'] . '</td>';
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        echo '<a href="view_order.php?o_id=' . $rows['o_id'] . '" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td>
																									</tr>';
